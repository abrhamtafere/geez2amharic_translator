...
export const LoginPage = () => {
  ...
  >
    <img src={"/images/google.jpg"} alt="Google logo" className="h-6 mr-3 " />
    <span className='text-light-blue-700 font-semibold'>Sign in with Google</span>
  </button>
</div>
  ...
  <input id="remember-me" type="checkbox" className="sr-only" /> {/* Hidden checkbox */}
  <label htmlFor="remember-me" className="relative flex items-center justify-center cursor-pointer block bg-gray-300 rounded-full w-9 h-4 transition duration-200 ease-in-out">
  ...
  <label htmlFor="remember-me" className="ml-3 text-sm text-gray-600 cursor-pointer">
    Remember Me
  </label>
</div>
            <div>
